...
namespace WebApplication5.Models
{
    ...
    public partial class otherEntities : DbContext
    {
        public otherEntities()
            : base("name=otherEntities")
        {
            var originalConnectionString = ConfigurationManager.ConnectionStrings["otherEntities"].ConnectionString;//修改Entities名稱
        ...
        public virtual DbSet<Tablemy7Tables1101661> Tablemy7Tables1101661 { get; set; }
        public virtual DbSet<Tablemy8Tables1101661> Tablemy8Tables1101661 { get; set; }
    }
}
